export function AiCityDiagram({ className }: { className?: string }) {
  return (
    <svg
      ...
      role="img"
      aria-label="AI City analogy: companies own plots, models are buildings, harnesses are storefronts, context and data run underground, and connectors, MCP, APIs, and computer use provide access."
      className={className}
    >
  ...
  <g transform="translate(850 38)">
    <rect width="296" height="74" rx="10" fill="#0b1826" stroke="#63b8f6" strokeOpacity="0.35"/>
    <text x="18" y="27" fill="#63b8f6" fontFamily="ui-monospace, SFMono-Regular, Consolas, monospace" fontSize="11" letterSpacing="1.6">THE DURABLE IDEA</text>
    <text x="18" y="50" fill="#dcecf8" fontSize="14">Harness and model are separate choices.</text>
  </g>
  ...
  {/* underground context and utilities */}
  <rect x="0" y="592" width="1200" height="228" fill="url(#aicity-ground)"/>
  <text x="54" y="632" fill="#edf7ff" fontSize="18" fontWeight="700">YOUR CONTEXT + THE OUTSIDE WORLD</text>
  <text x="54" y="656" fill="#8ea7ba" fontSize="13">files, notes, preferences, history, web data, apps, and services</text>

  <g>
    <rect x="54" y="684" width="190" height="70" rx="10" fill="#0c1b2b" stroke="#63b8f6" strokeOpacity="0.5"/>
    <text x="72" y="709" fill="#63b8f6" fontSize="11" fontWeight="700" letterSpacing="1.2">CONNECTOR</text>
    <text x="72" y="733" fill="#dcecf8" fontSize="14">Packaged app access</text>

    <rect x="264" y="684" width="190" height="70" rx="10" fill="#0c1b2b" stroke="#72e6d1" strokeOpacity="0.5"/>
    <text x="282" y="709" fill="#72e6d1" fontSize="11" fontWeight="700" letterSpacing="1.2">MCP</text>
    <text x="282" y="733" fill="#dcecf8" fontSize="14">Common agent adapter</text>

    <rect x="474" y="684" width="190" height="70" rx="10" fill="#0c1b2b" stroke="#b5a5ff" strokeOpacity="0.5"/>
    <text x="492" y="709" fill="#b5a5ff" fontSize="11" fontWeight="700" letterSpacing="1.2">API</text>
    <text x="492" y="733" fill="#dcecf8" fontSize="14">Software request contract</text>

    <rect x="684" y="684" width="190" height="70" rx="10" fill="#0c1b2b" stroke="#ffbd66" strokeOpacity="0.5"/>
    <text x="702" y="709" fill="#ffbd66" fontSize="11" fontWeight="700" letterSpacing="1.2">COMPUTER USE</text>
    <text x="702" y="733" fill="#dcecf8" fontSize="14">Screen-level fallback</text>

    <rect x="894" y="620" width="252" height="134" rx="12" fill="#0b1826" stroke="#63b8f6" strokeOpacity="0.35"/>
    <text x="914" y="648" fill="#63b8f6" fontSize="11" fontWeight="700" letterSpacing="1.2">HOW WORK REPEATS</text>
    <text x="914" y="678" fill="#edf7ff" fontSize="14" fontWeight="600">Prompt = work order</text>
    <text x="914" y="704" fill="#edf7ff" fontSize="14" fontWeight="600">Skill = reusable playbook</text>
    <text x="914" y="730" fill="#edf7ff" fontSize="14" fontWeight="600">Automation = standing order</text>
  </g>

  {/* utility risers */}
  <g strokeWidth="5" fill="none" filter="url(#aicity-glow)">
    <path d="M149 684 V592 H269 V514" stroke="#63b8f6" strokeOpacity="0.75"/>
    <path d="M359 684 V640 H599 V514" stroke="#72e6d1" strokeOpacity="0.75"/>
    <path d="M569 684 V656 H987 V514" stroke="#b5a5ff" strokeOpacity="0.75"/>
  </g>

  <text x="54" y="792" fill="#6f8799" fontFamily="ui-monospace, SFMono-Regular, Consolas, monospace" fontSize="10" letterSpacing="1.2">ACCESS IS NOT PERMISSION  /  CONNECT ONLY WHAT THE WORK NEEDS  /  VERIFY BEFORE YOU SHARE OR PUBLISH</text>
    </svg>
  );
}
